...
- **Status:** Accepted — all five phases implemented (attestation: SPIFFE verifier v1,
  records + trust-domain policy; cryptographic SVID validation deferred to enforce-mode)
- **Date:** 2026-06-07
- **Deciders:** ethchor
